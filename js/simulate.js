...
function runSimulation() {
    ...
    setTimeout(() => { pf.style.width = '100%'; }, 50);
    ...
    setTimeout(() => {
        ...
        visualizeSimulation(impactRadiusKm, baseAffected);
        showResults(baseAffected, impactRadiusKm, displaced, respWindow, sev, density);
    }, 2000);
}
...
function showResults(aff, rad, disp, win, sev, density) {
    ...
    document.getElementById('res-hist').innerText = `Based on historical data from ${Math.floor(Math.random()*40+10)} similar events.`;
